...
class XDDeactivationConfirmation extends StatelessWidget {
  XDDeactivationConfirmation({
    Key key,
  }) : super(key: key);
  @override
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(69.0, 157.0, 211.0, 72.0),
                    size: Size(349.0, 269.0),
                    pinLeft: true,
                    pinRight: true,
                    pinBottom: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(146.0, 177.0, 58.0, 33.0),
                    size: Size(349.0, 269.0),
                    fixedWidth: true,
                    fixedHeight: true,
                    child: Text(
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(74.0, 31.0, 202.0, 36.0),
                    size: Size(349.0, 269.0),
                    pinTop: true,
                    fixedWidth: true,
                    fixedHeight: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(66.0, 79.0, 218.0, 44.0),
                    size: Size(349.0, 269.0),
                    fixedWidth: true,
                    fixedHeight: true,
                    child: Text(

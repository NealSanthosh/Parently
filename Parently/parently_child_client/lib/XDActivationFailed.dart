...
class XDActivationFailed extends StatelessWidget {
  XDActivationFailed({
    Key key,
  }) : super(key: key);
  @override
          ...
          Transform.translate(
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(3.0, 555.0, 315.0, 50.0),
                    size: Size(318.0, 605.0),
                    pinLeft: true,
                    pinRight: true,
                    pinBottom: true,
                    fixedHeight: true,
                    child:
                      ...
                      children: <Widget>[
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(124.0, 16.0, 68.0, 18.0),
                          size: Size(315.0, 50.0),
                          fixedWidth: true,
                          fixedHeight: true,
                          child: Text(
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(106.0, 481.0, 110.0, 16.0),
                    size: Size(318.0, 605.0),
                    fixedWidth: true,
                    fixedHeight: true,
                    child: Text(
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 515.8, 315.0, 1.0),
                    size: Size(318.0, 605.0),
                    pinLeft: true,
                    pinRight: true,
                    pinBottom: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(78.0, 54.0, 166.0, 36.0),
                    size: Size(318.0, 605.0),
                    pinTop: true,
                    fixedWidth: true,
                    fixedHeight: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(94.0, 0.0, 136.0, 36.0),
                    size: Size(318.0, 605.0),
                    pinTop: true,
                    fixedWidth: true,
                    fixedHeight: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(32.5, 136.0, 256.0, 291.7),
                    size: Size(318.0, 605.0),
                    pinLeft: true,
                    pinRight: true,
                    fixedHeight: true,
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(39.0, 47.0, 272.0, 36.0),
                    size: Size(349.0, 269.0),
                    pinLeft: true,
                    pinRight: true,
                    fixedHeight: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(28.0, 93.0, 294.0, 19.0),
                    size: Size(349.0, 269.0),
                    pinLeft: true,
                    pinRight: true,
                    fixedHeight: true,
                    child: Text(
                      'Please reenter the activation code',
                      style: TextStyle(
                        fontFamily: 'Gibson',
                        fontSize: 19,
                        color: const Color(0xffffffff),

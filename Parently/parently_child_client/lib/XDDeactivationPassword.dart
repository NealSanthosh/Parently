...
import './XDDeactivationConfirmation.dart';
import 'package:adobe_xd/page_link.dart';
import './XDDeactivation.dart';
import 'package:flutter_svg/flutter_svg.dart';

class XDDeactivationPassword extends StatelessWidget {
  XDDeactivationPassword({
    Key key,
  }) : super(key: key);
  @override
          ...
          Transform.translate(
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 349.0, 283.0),
                    size: Size(349.0, 283.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(69.0, 192.0, 211.0, 72.0),
                    size: Size(349.0, 283.0),
                    pinLeft: true,
                    pinRight: true,
                    pinBottom: true,
                    ...
                    child: PageLink(
                      links: [
                        PageLinkInfo(
                          ease: Curves.easeOut,
                          duration: 0.3,
                          pageBuilder: () => XDDeactivationConfirmation(),
                        ),
                      ],
                      child: Container(
                        decoration: BoxDecoration(
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(17.0, 141.5, 315.0, 1.0),
                    size: Size(349.0, 283.0),
                    pinLeft: true,
                    pinRight: true,
                    fixedHeight: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(84.0, 113.0, 188.0, 36.0),
                    size: Size(349.0, 283.0),
                    fixedWidth: true,
                    fixedHeight: true,
                    child: Text(
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(152.0, 212.0, 47.0, 33.0),
                    size: Size(349.0, 283.0),
                    pinBottom: true,
                    fixedWidth: true,
                    fixedHeight: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(99.0, 24.0, 158.0, 36.0),
                    size: Size(349.0, 283.0),
                    pinTop: true,
                    fixedWidth: true,
                    fixedHeight: true,
...
const String _svg_hkuzvv =
    '<svg viewBox="27.0 394.7 315.0 1.0" ><path transform="translate(27.0, 394.66)" d="M 0 0 L 315 0" fill="none" stroke="#200c0c" stroke-width="6" stroke-opacity="0.22" stroke-miterlimit="4" stroke-linecap="round" /></svg>';

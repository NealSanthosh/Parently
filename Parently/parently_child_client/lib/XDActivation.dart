...
import './XDActivationAccpeted.dart';
import 'package:adobe_xd/page_link.dart';
import 'package:flutter_svg/flutter_svg.dart';

class XDActivation extends StatelessWidget {
  XDActivation({
    Key key,
  }) : super(key: key);
  @override
                    ...
                    child:
                      ...
                      links: [
                        PageLinkInfo(
                          ease: Curves.easeOut,
                          duration: 0.3,
                          pageBuilder: () => XDActivationAccpeted(),
                        ),
                      ],
                      child: Stack(
                        children: <Widget>[
                          ...
                          Pinned.fromSize(
                            bounds: Rect.fromLTWH(120.0, 15.0, 76.0, 20.0),
                            size: Size(315.0, 50.0),
                            fixedWidth: true,
                            fixedHeight: true,
                            child: Text(
...
const String _svg_vkn0p0 =
    '<svg viewBox="0.0 -0.3 315.0 50.0" ><path transform="translate(0.0, -0.3)" d="M 6 0 L 309 0 C 312.313720703125 0 315 2.686291217803955 315 6 L 315 44 C 315 47.3137092590332 312.313720703125 50 309 50 L 6 50 C 2.686291217803955 50 0 47.3137092590332 0 44 L 0 6 C 0 2.686291217803955 2.686291217803955 0 6 0 Z" fill="#ffffff" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_hkw68o =
    '<svg viewBox="27.0 605.8 315.0 1.0" ><path transform="translate(27.0, 605.8)" d="M 0 0 L 315 0" fill="none" stroke="#ffffff" stroke-width="4" stroke-opacity="0.05" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';

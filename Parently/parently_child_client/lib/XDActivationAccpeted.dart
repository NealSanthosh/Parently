...
import './XDDeactivation.dart';
import 'package:adobe_xd/page_link.dart';
import 'package:flutter_svg/flutter_svg.dart';

class XDActivationAccpeted extends StatelessWidget {
  XDActivationAccpeted({
    Key key,
  }) : super(key: key);
  @override
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(45.0, 47.0, 259.0, 36.0),
                    size: Size(349.0, 269.0),
                    pinLeft: true,
                    pinRight: true,
                    fixedHeight: true,

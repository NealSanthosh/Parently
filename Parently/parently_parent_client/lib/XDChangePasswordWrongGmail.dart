...
class XDChangePasswordWrongGmail extends StatelessWidget {
  XDChangePasswordWrongGmail({
    Key key,
  }) : super(key: key);
  @override
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(68.0, 47.0, 214.0, 36.0),
                    size: Size(349.0, 269.0),
                    fixedWidth: true,
                    fixedHeight: true,
                    child: Text(
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(62.0, 93.0, 226.0, 19.0),
                    size: Size(349.0, 269.0),
                    fixedWidth: true,
                    fixedHeight: true,
                    child: Text(
                      'This G-Mail Does Not Exist',
                      style: TextStyle(
                        fontFamily: 'Gibson',
                        fontSize: 19,
                        color: const Color(0xffffffff),

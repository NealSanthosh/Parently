...
import './XDChangePasswordnewpassword.dart';
import 'package:adobe_xd/page_link.dart';
import 'package:flutter_svg/flutter_svg.dart';

class XDChangePasswordenterotp extends StatelessWidget {
  XDChangePasswordenterotp({
    Key key,
  }) : super(key: key);
  @override
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                    ...
                    child:
                      ...
                      links: [
                        PageLinkInfo(
                          ease: Curves.linear,
                          duration: 0.3,
                          pageBuilder: () => XDChangePasswordnewpassword(),
                        ),
                      ],
                      child: Stack(
                        children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(5.5, 424.0, 308.0, 26.0),
                    size: Size(316.5, 611.0),
                    pinLeft: true,
                    pinRight: true,
                    fixedHeight: true,
                    child: Text(
                      'Enter OTP From Your G-Mail',
                      style: TextStyle(
                        fontFamily: 'Gibson',
                        fontSize: 26,

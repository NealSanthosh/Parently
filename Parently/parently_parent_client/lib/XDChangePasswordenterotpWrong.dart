...
class XDChangePasswordenterotpWrong extends StatelessWidget {
  XDChangePasswordenterotpWrong({
    Key key,
  }) : super(key: key);
  @override
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(119.0, 169.0, 112.0, 33.0),
                    size: Size(349.0, 269.0),
                    fixedWidth: true,
                    fixedHeight: true,
                    child: Text(
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(83.0, 47.0, 184.0, 36.0),
                    size: Size(349.0, 269.0),
                    fixedWidth: true,
                    fixedHeight: true,
                    child: Text(
